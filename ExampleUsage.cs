...
using ConstantsGeneratorPlugin.scripts.generated;

namespace ConstantsGeneratorPlugin.scripts;

public partial class ExampleUsage : Node3D
{
	public override void _Ready() {
		AudioServer.SetBusVolumeDb(AudioBus.Music, Mathf.LinearToDb(0.5f));
		AudioServer.SetBusVolumeDb(AudioBus.Sfx, Mathf.LinearToDb(0.8f));
	}
